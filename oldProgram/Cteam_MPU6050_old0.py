...
def calculate_angles(kalman_pitch, kalman_roll, kalman_yaw, prev_yaw_rate, dt, gyro_offsets, accel_offsets):
    ...
    gyro_x = (read_raw_data(GYRO_XOUT_H) - gyro_offsets['x']) / 16384.0 * 9.80665
    gyro_y = (read_raw_data(GYRO_XOUT_H + 2) - gyro_offsets['y']) / 16384.0 * 9.80665
    gyro_z = (read_raw_data(GYRO_XOUT_H + 4) - gyro_offsets['z']) / 16384.0 * 9.80665
