...
class Cteam_MPU6050_I2c:
    def init(self, _isDebugEnable:bool):
        ...
        self.i2cBus.write_byte_data(MPU6050_ADDR, LOW_PASS_FILTER, 5)
...
class Cteam_MPU6050_Cal:
    def init(self, _isDebugEnable:bool):
        ...
        self.velocityX:float = 0.0
        self.velocityY:float = 0.0
        self.velocityZ:float = 0.0
        
        self.displacementX:float = 0.0        
        self.displacementY:float = 0.0
        self.displacementZ:float = 0.0
        ...
        self.velocityXSimpson = Simpson()
        self.velocityYSimpson = Simpson()
        self.velocityZSimpson = Simpson()
        
        self.displacementXSimpson = Simpson()
        self.displacementYSimpson = Simpson()
        self.displacementZSimpson = Simpson()
        
        self.pitchSimpson = Simpson()
        self.rollSimpson = Simpson()
        self.yawSimpson = Simpson()
        
        self.velocityXSimpson.init()
        self.velocityYSimpson.init()
        self.velocityZSimpson.init()
        
        self.displacementXSimpson.init()
        self.displacementYSimpson.init()
        self.displacementZSimpson.init()
    ...
    def getVelocity(self, _dt): # Execute getAngle() before executing
        self.velocityXSimpson.simpson(self.acclX, _dt)
        self.velocityYSimpson.simpson(self.acclY, _dt)
        self.velocityZSimpson.simpson(self.acclZ, _dt)
        
        self.velocityX = self.velocityXSimpson.ans
        self.velocityY = self.velocityYSimpson.ans
        self.velocityZ = self.velocityZSimpson.ans
        
    def getDisplacement(self, _dt): # Execute getVelocity before executing
        self.displacementXSimpson.simpson(self.pitchRate, _dt)
        self.displacementYSimpson.simpson(self.rollRate, _dt)
        self.displacementZSimpson.simpson(self.yawRate, _dt)
        
        self.displacementX = self.displacementXSimpson.ans
        self.displacementY = self.displacementYSimpson.ans
